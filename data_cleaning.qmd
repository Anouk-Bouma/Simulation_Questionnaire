...
data <- data %>%
  mutate(Q16a_16_NEW = if_else(ID %in% c("id9", "id69"), 1, NA)) %>%
  mutate(Q18a_11_NEW = if_else(ID %in% c("id9", "id156", "id161", "id108", "id139"), 1, NA)) %>%
  mutate(Q16a_17_NEW = if_else(ID %in% c("id108", "id129", "id197", "id210"), 1, NA)) %>%
  mutate(Q18a_12_NEW = if_else(ID %in% c("id92", "id158"), 1, NA)) %>%
  mutate(Q18a_13_NEW = if_else(ID %in% c("id60", "id71", "id137", "id178"), 1, NA)) %>%
  mutate(Q20_9_NEW = if_else(ID %in% c("id27", "id36", "id105", "id165", "id191", "id204"), 1, NA)) %>%
  mutate(Q20_10_NEW = if_else(ID %in% c("id35", "id36", "id43", "id135", "id140"), 1, NA)) %>%
  mutate(Q20_11_NEW = if_else(ID %in% c("id161", "id165", "id188", "id213"), 1, NA))
...
data <- data %>%
  ...
  mutate(Q15 = if_else(ID %in% c("id21", "id85", "117", "122"), NA, Q15)) %>%
  ...
  mutate(Q28 = if_else(ID %in% c("id61"), NA, Q28))
