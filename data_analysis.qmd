...
plot_combined_questions <- function(
    ...
    # ---- 4. Percentages & factors (THE FIX IS HERE) ----
    plot_data <- counts %>%
    ...
    ggplot(
        ...
        scale_x_discrete(
            # DO NOT use limits = rev here; it conflicts with the manual factoring
...
# Figure 2 - Selective Reporting of Conditions, Methods, and Performance Measures
p_rationale_selective_reporting <- plot_combined_questions(data = data,
                               meta,
...
# Figure 3 - Rationale for Selective Reporting of Conditions, Methods, and Performance Measures
p7_10_13 <- plot_combined_questions(data,
                               ...
                               sample_sizes = sample_sizes,
                               combine_ab = TRUE,
                               title_plot = "Results weren't reported for all conditions/methods/performance measures because of...",
                               y_max = 100,
                               wrap_width = 65)

ggsave("Figure_3.png", plot = p7_10_13, width = 10, height = 8.8, dpi = 300)
