...
## Plot Combined Single Select (CAN BE DELETED?)
...
## Plot Combined Single Select Questions (Adjustable)
...
## Plots single select calls

```{r}

plot_combined_singleselect(data, meta, combined_questions = c("Q6", "Q9", "Q12"), title_plot = "Does the body of the paper report at least one result for every condition/method/performance measure?")
```
