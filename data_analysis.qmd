...
ggsave("Figure_2.png", plot = p_freq_selective_reporting, width = 10, height = 5, dpi = 300)
...
ggsave("Figure_3.png", plot = p_rationale_selective_reporting, width = 14.66*1.5, height = 13*1.5, units = "cm", dpi = 300)
...
arrange_fig5 <- ggarrange(p_rationale_missings, p_rationale_MCSE, nrow = 2, ncol = 1)
